...
- A color video can be represented as a 3D tensor (height × width × time).
...
Create the two methods two perform PCA
...
Compare the results in terms of computational efficiency

```{r pca-computational-efficiency-small}
...
Now, we try a bigger example

```{r pca-big-dataset, cache=TRUE}
# Simulate high-dimensional data
set.seed(123)
n <- 100    # Number of samples
